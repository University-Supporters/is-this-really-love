...
export const CALLERS = {
  female: [
    ...
    { name: '서준이',      audio: `${BASE}audio/male_4.mp3`, image: `${BASE}images/male_4.png` },
    { name: '도윤이',      audio: `${BASE}audio/male_5.mp3`, image: `${BASE}images/male_5.png` },
  ],
  male: [
    ...
    { name: '하은이',         audio: `${BASE}audio/female_4.mp3`, image: `${BASE}images/female_4.png` },
    { name: '서연이',         audio: `${BASE}audio/female_5.mp3`, image: `${BASE}images/female_5.png` },
  ],
};
