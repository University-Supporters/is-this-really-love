...
export default function SelectionScreen({ config, setConfig, onStart, loadProgress = 0, isLoaded = false }) {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-full max-h-full overflow-y-auto px-6 py-6 sm:py-10 animate-fade-in w-full">
      {/* 상단 콘텐츠 래퍼 */}
      <div className="flex flex-col items-center w-full max-w-md">
        ...
        {!isLoaded && (
          <div className="bg-slate-900/60 border border-white/5 rounded-2xl p-4 space-y-2.5 backdrop-blur-md animate-pulse">
            <div className="flex justify-between text-xs font-bold px-1 text-slate-300">
            ...
            <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden p-[1px] border border-slate-700/30">
              <div
      ...
      {/* 고지 문구 */}
      <footer className="w-full text-center py-4 mt-6 z-10">
