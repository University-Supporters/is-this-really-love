        ...
        if (state.os === 'ios') {
                    ...
                    <div class="actions">
                        <div style="text-align:center">
                            <button class="ios-btn decline" id="btn-ios-decline">
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="white"><path d="M12,9c-1.6,0-3.15,0.25-4.6,0.74c-0.45,0.15-0.9,0.26-1.4,0.26c-0.5,0-1-0.21-1.41-0.62L2.7,7.5C2.25,7.05,2,6.43,2,5.77 c0-0.67,0.26-1.28,0.7-1.72C5.1,1.65,8.42,0.5,12,0.5s6.9,1.15,9.3,3.55c0.44,0.44,0.7,1.05,0.7,1.72c0,0.66-0.25,1.28-0.7,1.72 l-1.89,1.89c-0.41,0.41-0.91,0.62-1.41,0.62c-0.5,0-0.95-0.11-1.4-0.26C15.15,9.25,13.6,9,12,9z"/></svg>
                            </button>
                            <p style="margin-top:10px; font-size:0.8rem">거절</p>
                        </div>
                        <div style="text-align:center">
                            <button class="ios-btn accept" id="btn-ios-accept">
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="white"><path d="M6.62,10.79c1.44,2.83,3.76,5.14,6.59,6.59l2.2-2.2c0.27-0.27,0.67-0.36,1.02-0.24c1.12,0.37,2.33,0.57,3.57,0.57 c0.55,0,1,0.45,1,1V20c0,0.55-0.45,1-1,1C10.75,21,3,13.25,3,4c0-0.55,0.45-1,1-1h3.5c0.55,0,1,0.45,1,1c0,1.24,0.2,2.45,0.57,3.57 c0.11,0.35,0.03,0.75-0.25,1.02L6.62,10.79z"/></svg>
                            </button>
            ...
            callUIContainer.innerHTML = `
                <div class="android-call fade-in">
                    <div class="caller-id">
                        <div class="caller-avatar" style="margin: 0 auto 30px"></div>
                        <h2>${callerName}</h2>
                        <p>수신 중...</p>
                    </div>
                    <div class="swipe-area">
                        <button class="ios-btn decline" id="btn-and-decline" style="width:60px; height:60px">
                             <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M12,9c-1.6,0-3.15,0.25-4.6,0.74c-0.45,0.15-0.9,0.26-1.4,0.26c-0.5,0-1-0.21-1.41-0.62L2.7,7.5C2.25,7.05,2,6.43,2,5.77 c0-0.67,0.26-1.28,0.7-1.72C5.1,1.65,8.42,0.5,12,0.5s6.9,1.15,9.3,3.55c0.44,0.44,0.7,1.05,0.7,1.72c0,0.66-0.25,1.28-0.7,1.72 l-1.89,1.89c-0.41,0.41-0.91,0.62-1.41,0.62c-0.5,0-0.95-0.11-1.4-0.26C15.15,9.25,13.6,9,12,9z"/></svg>
                        </button>
                        <button class="ios-btn accept" id="btn-and-accept" style="width:60px; height:60px">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M6.62,10.79c1.44,2.83,3.76,5.14,6.59,6.59l2.2-2.2c0.27-0.27,0.67-0.36,1.02-0.24c1.12,0.37,2.33,0.57,3.57,0.57 c0.55,0,1,0.45,1,1V20c0,0.55-0.45,1-1,1C10.75,21,3,13.25,3,4c0-0.55,0.45-1,1-1h3.5c0.55,0,1,0.45,1,1c0,1.24,0.2,2.45,0.57,3.57 c0.11,0.35,0.03,0.75-0.25,1.02L6.62,10.79z"/></svg>
                        </button>
                    </div>
                </div>
            `;
